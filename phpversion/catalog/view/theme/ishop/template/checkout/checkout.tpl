    ...
    <div class="panel-group" id="accordion">
      <div class="panel panel-default">
        <div class="panel-heading">
          <h4 class="panel-title login__title"><?php echo $text_checkout_option; ?></h4>
        </div>
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h4 class="panel-title login__title"><?php echo $text_checkout_payment_address; ?></h4>
        </div>
        <div class="panel-collapse collapse" id="collapse-payment-address">
          <div class="panel-body"></div>
        </div>
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h4 class="panel-title login__title"><?php echo $text_checkout_shipping_address; ?></h4>
        </div>
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h4 class="panel-title login__title"><?php echo $text_checkout_shipping_method; ?></h4>
        </div>
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h4 class="panel-title login__title"><?php echo $text_checkout_payment_method; ?></h4>
        </div>
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h4 class="panel-title login__title"><?php echo $text_checkout_confirm; ?></h4>
        </div>
