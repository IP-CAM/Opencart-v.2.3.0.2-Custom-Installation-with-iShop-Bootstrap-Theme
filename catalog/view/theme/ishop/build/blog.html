...
<header class="page-header" role="banner">
  <div class="page-header__logo">
    <a href="index.html" class="page-header__home">
      <img src="img/logo-black.svg" alt="Sports Store" class="page-header__logotype" width="206" height="26">
    </a>
  </div>
  <div class="page-header__buttons">
    ...
    <div class="page-header__inner">
      <a href="cart.html" class="page-header__cart">
        ...
        <span class="page-header__counter">1</span>
      </a>
      <div class="page-header__box">
        <ul class="page-header__items">
          <li class="page-header__item">
            <div class="page-header__wrap">
              <img src="img/1-20.jpg" alt="#" class="page-header__img" width="600" height="600">
              <div class="page-header__wrapper">
                <div class="page-header__links">
                  <a href="product.html" class="page-header__link">Кроссовки Nike RunAllDay</a>
                  <a href="#" class="page-header__link">
                    <span></span>
                    <span></span>
                  </a>
                </div>
                <div class="page-header__variations">
                  <span class="page-header__variation">Цвет:</span>
                  <span class="page-header__value">Черный</span>
                </div>
                <div class="page-header__quantity">
                  <span class="page-header__price">55 <span class="page-header__currency">Руб.</span></span>
                  <span class="page-header__value">x1</span>
                </div>
              </div>
            </div>
            <div class="page-header__total">
              <span class="page-header__subtotal">Всего:</span>
              <span class="page-header__price page-header__price--big">55 <span class="page-header__currency">Руб.</span></span>
            </div>
            <div class="page-header__btns">
              <a href="#" class="page-header__btn">В корзину</a>
              <a href="#" class="page-header__btn page-header__btn--orange">Оплатить</a>
            </div>
          </li>
        </ul>
      </div>
    ...
    <a href="login.html" class="page-header__login">
      <svg class="page-header__icon" width="20" height="20">
        <use x="0" y="0" xlink:href="#icon-user"></use>
      </svg>
    </a>
  </div>
  <nav class="main-nav main-nav--closed" style="display: none" role="navigation">
    ...
    <div class="container">
      <div class="breadcrumbs__inner">
        ...
        <ul class="breadcrumbs__list">
          ...
          <li class="breadcrumbs__item"><a href="#" class="breadcrumbs__link breadcrumbs__link--active">Блог</a></li>
        </ul>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="blog__inner">
        <div class="blog__posts">
          <ul class="blog__list">
            <li class="blog__item">
              <img src="img/6-860x526.jpg" alt="#" class="blog__img" width="860" height="526">
              <div class="blog__wrapper">
                <time class="blog__date" datetime="2018-05-05">5 Мая, 2018</time>
                <a href="#" class="blog__like">
                  <svg class="blog__icon" width="12" height="12">
                    <use x="0" y="0" xlink:href="#icon-heart"></use>
                  </svg>
                  <span class="blog__counter">12</span>
                </a>
                <a href="#" class="blog__comment">
                  <svg class="blog__icon" width="12" height="12">
                    <use x="0" y="0" xlink:href="#icon-heart"></use>
                  </svg>
                  <span class="blog__counter">5</span>
                </a>
              </div>
              <h2 class="blog__title">6 причин заниматься спортом</h2>
              <p class="blog__text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. In, quasi.</p>
              <div class="blog__category">Категория: <a href="#" class="blog__link">Советы</a></div>
            </li>
            <li class="blog__item">
              <img src="img/6-860x526.jpg" alt="#" class="blog__img" width="860" height="526">
              <div class="blog__wrapper">
          ...
          <button class="blog__btn">Загрузить больше</button>
        </div>
        <aside class="blog__aside">
          <form action="#" class="blog__field">
            <input type="search" class="blog__input" aria-label="Введите название" placeholder="Введите название">
            <button class="blog__button">
              <svg class="blog__icon" width="20" height="20">
                <use x="0" y="0" xlink:href="#icon-search"></use>
              </svg>
            </button>
          </form>
          <h3 class="blog__title blog__title--margin blog__title--small">Категории</h3>
          <ul class="blog__list blog__list--margin">
            <li class="blog__item blog__item--nomarg"><a href="#" class="blog__link">Советы</a></li>
            <li class="blog__item blog__item--nomarg"><a href="#" class="blog__link">Мода</a></li>
            <li class="blog__item blog__item--nomarg"><a href="#" class="blog__link">Идеальное тело</a></li>
            <li class="blog__item blog__item--nomarg"><a href="#" class="blog__link">Тренировки</a></li>
          </ul>
          <h3 class="blog__title blog__title--margin blog__title--small">Блог</h3>
          <div class="blog__tabs">
            <ul data-tabs="" class="blog__tabslist tabs">
              <li class="blog__tabitem"><a data-tab="" href="#taba" class="blog__tablink active">Последние</a></li>
              <li class="blog__tabitem"><a data-tab="" href="#tabb" class="blog__tablink">Популярные</a></li>
            </ul>
            <div class="blog__box" data-tabs-content="">
              <div data-tabs-pane="" class="blog__tab tabs-pane active" id="taba">
                <ul class="blog__list">
                  <li class="blog__post">
                    <img src="img/6-580x420.jpg" alt="#" class="blog__thumb" width="284" height="206">
                    <div class="blog__desc">
                      <a href="#" class="blog__link blog__link--orange">6 причин заняться спортом</a>
                      <time class="blog__date" datetime="2018-05-05">5 мая, 2018</time>
                    </div>
                  </li>
                  <li class="blog__post">
              ...
              <div class="blog__tab tabs-pane" data-tabs-pane="" id="tabb">
                <ul class="blog__list">
                  <li class="blog__post">
                    <img src="img/6-580x420.jpg" alt="#" class="blog__thumb" width="284" height="206">
                    <div class="blog__desc">
          ...
          <h3 class="blog__title blog__title--margin blog__title--small">Подпишитесь на нашу рассылку</h3>
          <form action="#" class="blog__field">
            <input type="email" class="blog__input blog__input--margin" placeholder="Ваш e-mail" aria-label="email">
            <button class="blog__btn blog__btn--nomargin" type="submit">Подписаться!</button>
          </form>
        </aside>
      </div>
    </div>
  ...
  <div class="container">
    <div class="page-footer__logo">
      <a href="index.html" class="page-footer__link">
        <img src="img/logo-white.svg" alt="Sports Store" class="page-footer__logotype  " width="206" height="26">
      </a>
    </div>
...
<script>
  document.addEventListener('DOMContentLoaded', () => {
    const styles = ['css/style.min.css'];
  styles.forEach((path) => {
